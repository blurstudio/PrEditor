...
.. warning::
   ...
   Since Python 2.5, the python standard library has provided a very powerful and fast
   XML reading and writing interface very similar to this blurdev module -- `ElementTree
   <http://docs.python.org/library/xml.etree.elementtree.html>`_.
...
from .xmlelement import XMLElement  # noqa: F401
from .xmldocument import XMLDocument  # noqa: F401
from .minidom import escape, unescape  # noqa: F401
