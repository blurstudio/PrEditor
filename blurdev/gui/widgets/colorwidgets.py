...
class ColorPickerWidget(QWidget):
    ...
    def alphaRect(self):
        if self.showAlpha():
            return QRect(
                ColorPickerWidget.BarWidth + 7,
                self.height() - ColorPickerWidget.BarWidth - 2,
                self.width() - ColorPickerWidget.BarWidth - 8,
                ColorPickerWidget.BarWidth,
            )
        return QRect()
    ...
    def colorRect(self):
        if self.showAlpha():
            return QRect(
                ...
                1,
                self.width() - ColorPickerWidget.BarWidth - 8,
                self.height() - ColorPickerWidget.BarWidth - 8,
            )
        else:
            return QRect(
                ColorPickerWidget.BarWidth + 7,
