...
class ToolsWidget(QWidget):
    def __init__(self, parent):
        ...
        self.uiSelectionModeBTN.setIcon(
            QIcon(blurdev.resourcePath('img/preview/select.png'))
        )
        self.uiPencilModeBTN.setIcon(
            QIcon(blurdev.resourcePath('img/preview/pencil.png'))
        )
        self.uiBrushModeBTN.setIcon(
            QIcon(blurdev.resourcePath('img/preview/brush.png'))
        )
