...
class LayersWidget(QWidget):
    def __init__(self, parent, scene):
        ...
        self.uiNewTextLayerBTN.setIcon(
            QIcon(blurdev.resourcePath('img/preview/type.png'))
        )
        self.uiNewMediaLayerBTN.setIcon(
            QIcon(blurdev.resourcePath('img/preview/media.png'))
        )
