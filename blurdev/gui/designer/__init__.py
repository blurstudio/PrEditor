...
#
#   \remarks    This package contains classes that expose blurdev widgets to the Qt
#               Designer
#
...
def loadPlugins(filename, importPath=""):
    ...
    if importPath:
        ...
        if os.path.exists(importPath) and importPath not in sys.path:
    ...
    if doc.load(filename):
        for child in doc.root().children():
            ...
            # create a standard plugin
                ...
                createPlugin(
                    child.attribute("module"),
                    child.attribute("class"),
                    child.attribute("icon"),
                    child.attribute("group", "Blur Widgets"),
                    eval(child.attribute("container", "False")),
                )
