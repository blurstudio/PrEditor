...
class DockWidget(QDockWidget):
    ...
    def instance(cls, parent=None):
        """
            :remarks	If you only want to have one instance of a DockWidget, use this method instead of creating a new DockWidget.
    ...
    def __init__(self, parent=None, flags=0):
        ...
        # any subclasses to stick around in memory even when the DockWidget is closed.
