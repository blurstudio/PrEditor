...
class SoftimageCore(Core):
    ...
    blurdev within Softimage sessions
    """
    ...
    def isKeystrokesEnabled(self):
        # Checks all of the top level windows of Qt against the win32 forground window
        # id to see if qt has focus
    ...
    def createToolMacro(self, tool, macro_name):
        ...
        # TODO: Sanitize the display name in order to remove any potential characters
        # that will not translate well to a command name.
