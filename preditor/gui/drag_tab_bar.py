...
class DragTabBar(QTabBar):
    ...
    Attributes:
        bg_color_map (dict): Description
        changedColor (TYPE): Description
        changedLinkedColor (TYPE): Description
        dirtyColor (TYPE): Description
        dirtyLinkedColor (TYPE): Description
        fg_color_map (dict): Description
        linkedColor (TYPE): Description
        mime_type (TYPE): Description
        missingLinkedColor (TYPE): Description
        normalColor (TYPE): Description
        orphanedColor (TYPE): Description
